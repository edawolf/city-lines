...
export class ElementAgentFactory {
   ...
   */
  private analyzeByPosition(element: DisplayObject): ElementAnalysis | null {
    const bounds = element.getBounds();
   ...
   */
  private analyzeBySize(element: DisplayObject): ElementAnalysis | null {
    const bounds = element.getBounds();
  ...
  public createDebugButton(id: string, element: DisplayObject): void {
  ...
  public createMainMenuButton(id: string, element: DisplayObject): void {
  ...
  public createCornerIcon(id: string, element: DisplayObject): void {
  ...
  public createTestElement(id: string, element: DisplayObject): void {
  ...
  public createBackground(id: string, element: DisplayObject): void {
