...
export class LayoutExecutor {
   ...
   */
  private createExecutionPlan(analysis: GlobalAnalysisReport): ExecutionPlan {
   ...
   */
  private planVisibilityCorrections(
    analysis: GlobalAnalysisReport,
    plan: ExecutionPlan,
  ): void {
   ...
   */
  private planConflictResolution(
    analysis: GlobalAnalysisReport,
    plan: ExecutionPlan,
  ): void {
   ...
   */
  private findSafePosition(_elementId: string): Position {
